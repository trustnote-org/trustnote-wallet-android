...
open class ShadowView @JvmOverloads constructor(context: Context?, attributeSet: AttributeSet? = null, defStyleInt: Int = 0)
    ...
    init {
        ...
        shadowDy = a.getDimensionPixelSize(R.styleable.ShadowView_shadowDy, 1).toFloat()
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        canvas?.let {
            ...
            //val path = canvas.drawRoundRect(RectF(0f, 100f, 100f, 300f), cornerRadiusTL, cornerRadiusTL, bgPaint)
